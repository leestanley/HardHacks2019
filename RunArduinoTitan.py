...
while oneMinuteCounter < 3:
    ...
    # assign array value with counter
    twoSecondArray[twoSecondCounter] = persons
    # increment counter
    twoSecondCounter += 1

    if twoSecondCounter == 30:
        oneMinuteArray[oneMinuteCounter] = ( sum(twoSecondArray) / 30 )
        oneMinuteCounter += 1
        if oneMinuteCounter == 3:
            print(oneMinuteArray)
        twoSecondCounter = 0
